...
I haev built stochastic, individual-based simulation model . In this spatially explicit model, individual organisms move across a landscape and make .. .  . 


Further, the model can a community framework, where individuals of different species
...
### Results/Conclusions ##
I found that a hetergenous environment, where perception matters...

Preliminary analyses show that interactions between the spatial scales of individual movement (local vs global dispersal) and the structure patch quality determine patterns of colonization. In particular, ... .
...
At the community level, I find that habitat selection in structured landscapes leads to increased beta diversity in low quality patches. 
